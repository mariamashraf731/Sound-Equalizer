...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.signal_before = PlotWidget(self.verticalLayoutWidget)
        self.signal_before.setObjectName("signal_before")
        self.signal_before.setBackground('w')
        self.verticalLayout.addWidget(self.signal_before)
        ...
        self.signal_after = PlotWidget(self.verticalLayoutWidget_3)
        self.signal_after.setObjectName("signal_after")
        self.signal_after.setBackground('w')
        self.verticalLayout_3.addWidget(self.signal_after)
        self.verticalLayoutWidget_6 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(610, 150, 601, 350))
        ...
        self.Palette1 = QtWidgets.QAction(MainWindow)
        self.Palette1.setObjectName("Palette1")
        self.Palette2 = QtWidgets.QAction(MainWindow)
        self.Palette2.setObjectName("Palette2")
        self.Palette3 = QtWidgets.QAction(MainWindow)
        self.Palette3.setObjectName("Palette3")
        self.Palette4 = QtWidgets.QAction(MainWindow)
        self.Palette4.setObjectName("Palette4")
        self.Palette5 = QtWidgets.QAction(MainWindow)
        self.Palette5.setObjectName("Palette5")
        ...
        self.menuSpectrogram.addAction(self.Palette1)
        self.menuSpectrogram.addAction(self.Palette2)
        self.menuSpectrogram.addAction(self.Palette3)
        self.menuSpectrogram.addAction(self.Palette4)
        self.menuSpectrogram.addAction(self.Palette5)
        ...
        self.Palette1.triggered.connect(lambda: self.palette(1))
        self.Palette2.triggered.connect(lambda: self.palette(2))
        self.Palette3.triggered.connect(lambda: self.palette(3))
        self.Palette4.triggered.connect(lambda: self.palette(4))
        self.Palette5.triggered.connect(lambda: self.palette(5))

        self.xmax_scale=10
        self.xmin_scale=0
        self.pen2=pg.mkPen((0,0,255))
        self.Signals=[self.signal_before,self.signal_after]
        self.data=[]
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Palette1.setShortcut(_translate("MainWindow", "Ctrl+1"))
        self.Palette2.setShortcut(_translate("MainWindow", "Ctrl+2"))
        self.Palette3.setShortcut(_translate("MainWindow", "Ctrl+3"))
        self.Palette4.setShortcut(_translate("MainWindow", "Ctrl+4"))
        self.Palette5.setShortcut(_translate("MainWindow", "Ctrl+5"))
        ...
        self.Palette1.setText(_translate("MainWindow", "Palette 1"))
        self.Palette2.setText(_translate("MainWindow", "Palette 2"))
        self.Palette3.setText(_translate("MainWindow", "Palette 3"))
        self.Palette4.setText(_translate("MainWindow", "Palette 4"))
        self.Palette5.setText(_translate("MainWindow", "Palette 5"))
    ...
    def open(self):
        ...
        self.Signals[0].plot(self.time,self.data,pen=self.pen2)
        self.Signals[0].setXRange(self.xmin_scale,self.xmax_scale)
        self.Signals[1].plot(self.time,self.data,pen=self.pen2)
        self.Signals[1].setXRange(self.xmin_scale,self.xmax_scale)
        self.x_range=self.Signals[0].getViewBox().state['viewRange'][0]
        self.Signals[0].setYRange(min(self.data),max(self.data))
        self.bands()
    ...
    def fft(self,signal):
        ...
        # self.Signals[2].plot(self.xf,np.abs(self.yf),pen=self.pen2) 
        # self.Signals[2].setYRange(0,max(np.abs(self.yf)))
        
    def recover_signal(self):
        self.yt=ifft(np.multiply(np.array(self.after_rq),np.exp(1j*self.phase)))
        print(len(self.yt))
        self.Signals[1].clear()
        self.Signals[1].plot(self.time,np.real(self.yt),pen=self.pen2)
        self.Signals[1].setXRange(self.x_range[0],self.x_range[1])
        self.Signals[1].setYRange(min(np.real(self.yt)),max(np.real(self.yt)))
    ...
    def zoom(self,val):
        ...
        if self.x_range[0] <=  0:
            self.x_range[0]= 0
        self.signal_before.setXRange(self.x_range[0],self.x_range[1])
        self.signal_after.setXRange(self.x_range[0],self.x_range[1])
    ...
    def update(self):
            if self.x_range[1] < np.max(self.time):
                ...
                self.Signals[0].setXRange(self.x_range[0],self.x_range[1])
                self.Signals[1].setXRange(self.x_range[0],self.x_range[1])
